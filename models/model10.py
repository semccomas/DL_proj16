...
cs = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(seq_input)
cs = Dropout(0.4)(cs)
cs = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(cs)
cs = Dropout(0.4)(cs)
cs = Convolution1D(50, 3, init = 'he_uniform', activation = 'relu')(cs)
cs = Dropout(0.4)(cs)
cs = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(cs)
...
cp = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(pssm_input) 
cp = Dropout(0.4)(cp)
cp = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(cp)
cp = Dropout(0.4)(cp)
cp = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(cp)
cp = Dropout(0.4)(cp)
cp = Convolution1D(50, 3, init = 'he_uniform', activation= 'relu')(cp)
...
x = Dropout(0.5)(x)
x = Dense(500, init= 'he_uniform', activation='relu', W_regularizer=l2(10 **(-6)))(x)
x = Dropout(0.5)(x)
